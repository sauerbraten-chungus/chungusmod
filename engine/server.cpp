...
#define vectorucharbinary lua_buff_type(&vector<uchar>::buf, &vector<uchar>::ulen)
    getGlobalNamespace(L).beginNamespace("engine")
        ...
        .beginClass<ucharbuf>("ucharbuf")
            ...
            .addData("maxlen", &ucharbuf::maxlen)
        ...
        .endClass()
        .beginClass<vector<uchar>>("vector<uchar>")
...
#undef add
        ...
        .endClass()
        //iengine.h
        .beginClass<selinfo>("selinfo")
            .template addConstructor<void(*)()>()
            .addData("corner", &selinfo::corner)
            .addData("cx", &selinfo::cx)
            .addData("cxs", &selinfo::cxs)
            .addData("cy", &selinfo::cy)
            .addData("cys", &selinfo::cys)
            .addData("o", &selinfo::o)
            .addData("s", &selinfo::s)
            .addData("grid", &selinfo::grid)
            .addData("orient", &selinfo::orient)
        .endClass()
